/**
 * #### Bolo de Aniversário | Outlined | Regular | SVG.
 * 
 * <br/>
 * 
 * `No Angular TS:`
 * ```ts
 * import { cakeRegular } from '@iconis/icons';
 ...
 *   this.iconeCake = this.sanitizer.bypassSecurityTrustHtml(cakeRegular);
 *  }
 * }
 * ```
 * 
 ...
 * ```
 */
export const cakeRegular: string = `
