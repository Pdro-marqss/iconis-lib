/**
 * @description
 * Simbolo dinheiro circulando | Outlined | Thin | SVG.
 * 
 * <br/>
 * 
 * `No Angular TS:`
 * ```ts
 * import { refundThin } from '@iconis/icons';
 ...
 *   this.iconeReembolso = this.sanitizer.bypassSecurityTrustHtml(refundThin);
 *  }
 * }
 * ```
 * 
 ...
 *
 *  constructor(private readonly sanitizer: DomSanitizer) {
 *   this.iconeReembolso = this.sanitizer.bypassSecurityTrustHtml(refundRegular);
 *  }
 * }
 * ```
 * 
 ...
 * ```
 */
export const refundRegular: string = `
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" fill="currentColor">
